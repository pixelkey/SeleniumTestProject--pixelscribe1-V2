...
describe('Move Rooms Function Verification', function () {
    ...
    it('Validate move rooms', async function () {
        ...
        try {
            ...
            await takeScreenshot(driver, 'tc005_moveRooms', 'rooms_creation_page_before_room_swap.png', this);

            await driver.sleep(2000); // Wait for 2 seconds
            // Click on redo button
            await roomsPageInstance.swapSecondAndFirstRooms();
            ...
            await takeScreenshot(driver, 'tc005_moveRooms', 'rooms_creation_page_after_room_swap.png', this);
        }
        catch (error) {
